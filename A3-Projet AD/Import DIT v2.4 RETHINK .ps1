...
$myOUs = @("Direction", "AdminFinance", "Metiers", "Commercial", "RH")
$myGroups = @("Employes", "Direction", "AdminFinance", "Metiers", "Commercial", "RH")
...
#********************Création des Groupes********************************
    ...
    New-ADGroup -Name Metiers -GroupScope Global -GroupCategory Security -Path "ou=Metiers,ou=Employes,dc=$dc1,dc=$dc2"
...
#********************Ajout des Groupes aux groupes********************************
    ...
    Add-ADGroupMember -Identity ACL_Metiers_RW -Members Metiers
    ...
    Add-ADGroupMember -Identity Employes -Members Direction, AdminFinance, Metiers, Commercial, RH
...
$myDir = @("SHARE", "USERS_DIR", "SHARE\Direction", "SHARE\AdminFinance", "SHARE\Metiers", "SHARE\Commercial", "SHARE\RH", "SHARE\Employes")
...
$myShares = @("Direction", "AdminFinance", "Metiers", "Commercial", "RH", "Employes")
