...
function InstallDHCPScope
{
    ...
    } -ArgumentList $Global:NETID, $Global:REMOTEPCNAME, $Global:IP, $Global:INDEXINF, $Global:ADAPTER, $Global:ROOTCredentials, $Global:SCOPENAME, $Global:STARTRANGE, $Global:STOPRANGE, $Global:MASK, $Global:DOMAIN, $Global:DNS1, $Global:DNS2, $Global:GATEWAY, $Global:SCOPEID, $Global:STARTEXCLUSION, $Global:STOPEXCLUSION
